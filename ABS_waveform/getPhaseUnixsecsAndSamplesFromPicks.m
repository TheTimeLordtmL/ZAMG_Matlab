...
fprintf('Phases %s: (P1)%s    (S1)%s    P-S(%3.1f)   (t0)%s\n',setting.station1,epoch2str(setting.waveforms.P1,'%G %H:%M:%S.%s'),epoch2str(setting.waveforms.S1,'%G %H:%M:%S.%s'),setting.waveforms.S1-setting.waveforms.P1,epoch2str(setting.waveforms.t01,'%G %H:%M:%S.%s'));
fprintf('Phases %s: (P2)%s    (S2)%s    P-S(%3.1f)   (t0)%s\n',setting.station2,epoch2str(setting.waveforms.P2,'%G %H:%M:%S.%s'),epoch2str(setting.waveforms.S2,'%G %H:%M:%S.%s'),setting.waveforms.S2-setting.waveforms.P2,epoch2str(setting.waveforms.t02,'%G %H:%M:%S.%s'));

fprintf('get data1 from %s to %s (setting.time.start1/end1)\n',setting.time.start1,setting.time.end1);
fprintf('get data2 from %s to %s (setting.time.start2/end2)\n',setting.time.start2,setting.time.end2);
